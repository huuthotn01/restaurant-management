        ...
        return (
            ...
            <Form.Group>
                ...
                <Form.Group>
                    ...
                    <Form.Control id="l-name" value='Trần Nguyễn' type="text" />
                </Form.Group>
                <Form.Group>
                    <Form.Label>Tên</Form.Label>
                    <Form.Control id="f-name" value='Hữu Thọ' type="text" />
                </Form.Group>
                <Form.Group>
                    <Form.Label>Email</Form.Label>
                    <Form.Control id="email" value='huutho@gmail.com' type="email" />
                </Form.Group>
                <Form.Group>
                    <Form.Label>Điện thoại</Form.Label>
                    <Form.Control id="phone" value='0944968379' type="text" pattern="[0-9]{10}" />
                </Form.Group>
            ...
            <Alert id='pass-alert' variant='info' style={{display: 'none', marginTop: '5px', paddingTop: '10px', paddingBottom: '10px', fontSize: '14px'}} >Đổi thông tin thành công</Alert>
            </>
        );
    }
}
