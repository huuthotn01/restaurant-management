                ...
                <Row>
                    <Col md="6">
                        ...
                        <Card className="cat-manager-item-right">
                            <img className="cat-manager-img" width="91.98px" height="90px" src="/assets/images/manage_order.png" alt = "Xem hồ sơ bệnh án"></img>
                            <CardBody>
                    ...
                    <Col md="6">
                        <Card className="cat-manager-item-right">
                            <img className="cat-manager-img" width="90px" height="95px" src="/assets/images/manage_staff.png" alt = "Đặt lịch khám"></img>
                            <CardBody>
                    ...
                    <Col md="6">
                        <Card className="cat-manager-item-left">
                            <img className="cat-manager-img" width="94px" height="95px" src="/assets/images/manage_menu.png" alt = "Hủy lịch khám"></img>
                            <CardBody>
